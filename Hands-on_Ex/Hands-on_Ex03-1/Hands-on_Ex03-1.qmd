...
## [3.1]{style="color:DarkOrange"} Learning Outcome
...
## [3.2]{style="color:DarkOrange"} Getting Started
...
## [3.3]{style="color:DarkOrange"} Importing Data
...
## [3.4]{style="color:DarkOrange"} Interactive Data Visualisation - ggiraph Methods
...
### [3.4.1]{style="color:DarkOrange"} Tooltip Effect with *Tooltip* Aesthetic
...
## [3.5]{style="color:DarkOrange"} Interactivity
...
### [3.5.1]{style="color:DarkOrange"} Displaying Multiple Information on Tooltip
...
## [3.6]{style="color:DarkOrange"} Interactivity
...
### [3.6.1]{style="color:DarkOrange"} Customising Tooltip Style
...
### [3.6.3]{style="color:DarkOrange"} Hover effect with *data_id* aesthetic
...
### [3.6.4]{style="color:DarkOrange"} Styling Hover Effect
...
### [3.6.5]{style="color:DarkOrange"} Combining Tooltip and Hover Effect
...
### [3.6.6]{style="color:DarkOrange"} Click Effect with onclick
...
### [3.6.7]{style="color:DarkOrange"} Coordinated Multiple Views with ggiraph
...
## [3.7]{style="color:DarkOrange"} Interactive Data Visualisation - plotly Methods!
...
### [3.7.1]{style="color:DarkOrange"} Creating an Interactive Scatter Plot: plot_ly() Method
...
- plot_ly() is interactive by default as compared to ggplot2 [Hands-On Exercise 3: Section 3.5](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#interactivity)
:::
...
### [3.7.3]{style="color:DarkOrange"} Creating an interactive scatter plot: `ggplotly()` method
...
- This is much simpler as compared to the ggplot2 tooltip method in [Hands-On Exercise 3: Section 3.5.1](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#displaying_multiple_information_on_tooltip)
:::

### [3.7.4]{style="color:DarkOrange"} Coordinated multiple views with plotly
...
- This code is much simpler than the ggiraph method in [Hands-On Exercise 3: Section 3.6.7](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#coordinated-multiple-views-with-ggiraph)
...
- Clicking on any data point results in a permanent selection, with no way to deselect.
:::
...
::: callout-tip
- But is it possible to make it on hover instead?
    - By default, highlight_key() works on click, not hover but using plotly_hover allows it to mirror the ggiraph method in [Hands-On Exercise 3: Section 3.6.7](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#coordinated-multiple-views-with-ggiraph)
- And how about fixing the annoying permanent selection issue?
...
## [3.8]{style="color:DarkOrange"} Interactive Data Visualisation - crosstalk Methods!
...
### [3.8.1]{style="color:DarkOrange"} Interactive Data Table: DT Package
...
### [3.8.2]{style="color:DarkOrange"} Linked brushing: crosstalk Method
...
## [3.8.3]{style="color:DarkOrange"} Fixing Data Table
The DataTables above have 2 extra columns (tooltip and onclick). This is because they were added in [Hands-On Exercise 3 :Section 3.5.1](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#displaying_multiple_information_on_tooltip) for tooltip and in [Hands-On Exercise 3 :Section 3.6.6](https://isss608-ay2024-25t3.netlify.app/hands-on_ex/hands-on_ex03/hands-on_ex03#click_effect_with_onclick) for onclick.
...
## [3.9]{style="color:DarkOrange"} Reference

### [3.9.1]{style="color:DarkOrange"} ggiraph
...
### [3.9.2]{style="color:DarkOrange"} plotly for R
