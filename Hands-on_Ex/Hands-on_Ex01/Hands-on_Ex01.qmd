...
## [1.1]{style="color:DarkOrange"} Learning Outcome
...
## [1.2]{style="color:DarkOrange"} Getting Started

### [1.2.1]{style="color:DarkOrange"} Install and Load the Required Libraries
...
::: callout-note
Patchwork is used for easier comparisons between graphs. Further explanation on how to create it can be found in [Hands-on Exercise 2: Section 2.5.1](https://r4va.netlify.app/chap02#creating-composite-graphics-pathwork-methods)
:::

### [1.2.2]{style="color:DarkOrange"} Importing the Data
...
## [1.3]{style="color:DarkOrange"} Introducing ggplot
...
### [1.3.1]{style="color:DarkOrange"} R Graphics VS ggplot
...
## [1.4]{style="color:DarkOrange"} Grammar of Graphics
...
### [1.4.1]{style="color:DarkOrange"} A Layered Grammar of Graphics

ggplot2 is an implementation of Leland Wilkinson’s Grammar of Graphics. Figure below shows the seven grammars of ggplot2.

![](/Hands-on_Ex/Hands-on_Ex01/image/layer.jpg){fig-align="center" width="800"}

[Reference: Hadley Wickham (2010) [“A layered grammar of graphics.”](https://vita.had.co.nz/papers/layered-grammar.html) Journal of Computational and Graphical Statistics, vol. 19, no. 1, pp. 3–28.]{style="color:grey" style="font-size: 10px;"}
...
## [1.5]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: Data
...
## [1.6]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: [Aesthetic Mappings](https://ggplot2.tidyverse.org/articles/ggplot2-specs.html)
...
## [1.7]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: geom
...
### [1.7.1]{style="color:DarkOrange"} Geometric Objects: geom_bar()
...
### [1.7.2]{style="color:DarkOrange"} Geometric Objects: geom_dotplot()
...
::: callout-note
The code uses patchwork for easier comparisons between graphs. Further explanation on how to create it can be found in [Hands-on Exercise 2: Section 2.5.1](https://r4va.netlify.app/chap02#creating-composite-graphics-pathwork-methods)
:::

### [1.7.3]{style="color:DarkOrange"} Geometric Objects: geom_histogram()
...
### [1.7.4]{style="color:DarkOrange"} Modifying a geometric object by changing geom()
...
### [1.7.5]{style="color:DarkOrange"} Modifying a geometric object by changing aes()
...
### [1.7.6]{style="color:DarkOrange"} Geometric Objects: geom-density()
...
### [1.7.7]{style="color:DarkOrange"} Geometric Objects: geom_boxplot()
...
### [1.7.8]{style="color:DarkOrange"} Geometric Objects: geom_violin
...
### [1.7.9]{style="color:DarkOrange"} Geometric Objects: Geometric Objects: geom_point()
...
### [1.7.10]{style="color:DarkOrange"} geom objects can be combined
...
## [1.8]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: Stat
...
### [1.8.1]{style="color:DarkOrange"} Working with `stat()`
...
### [1.8.2]{style="color:DarkOrange"} Working with stat - the stat_summary() method

The left graph adds mean values by using stat_summary() function and overriding the default geom.

### [1.8.3]{style="color:DarkOrange"} Working with stat - the geom() method
...
### [1.8.4]{style="color:DarkOrange"} Adding a Best-Fit Curve on a Scatterplot?
...
## [1.9]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: Facets
...
### [1.9.1]{style="color:DarkOrange"} Working with `facet_wrap()`
...
### [1.9.2]{style="color:DarkOrange"} Working with `facet_grid()`
...
## [1.10]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: Coordinates
...
### [1.10.1]{style="color:DarkOrange"} Working with Coordinate
...
### [1.10.1]{style="color:DarkOrange"} Changing the y- and x-axis Range
...
## [1.11]{style="color:DarkOrange"} Essential Grammatical Elements in ggplot2: Themes
...
## [1.12]{style="color:darkorange"} Reference
