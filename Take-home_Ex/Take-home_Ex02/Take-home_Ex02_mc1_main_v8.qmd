...
## [2:]{style="color:DarkOrange"} 3.8 Temporal Validation
...
## [2:]{style="color:DarkOrange"} 3.9 Check for orphan nodes
...
## [2:]{style="color:DarkOrange"} 3.10 Creating Consistent Visualisation Colouring
...
## [2:]{style="color:DarkOrange"} 3.11 Creating the Global Knowledge Graph
...
creator_and_songs_and_influences_and_creators <- creator_and_songs_and_influences %>%
  left_join(creator_out_edges %>% select(from, to), by = c("influenced_to" = "to"), relationship = "many-to-many") %>%
...
creator_stats %>%
  arrange(desc(collaboration_influence_creator)) %>%
  head(10) %>%
  rename(
    `Artist` = creator_name,
    `Total Songs` = total_songs,
  ...
  kable(caption = "Top 10 Artists by Number of Influencd Artists and Collaborations") %>%
  kable_styling("striped", full_width = F) %>% 
  scroll_box(height = "200px")
...
-   Most Influential Artist (Influence Artists and Collaborations) and Most Music Influence: Min Fu
...
### [2:]{style="color:DarkOrange"} 6.2.3 Visualizing the career of Min Fu
...
-   Min Fu is the most influential artist having influenced/collaborated with 598 artists and influenced the creation of 192 music.
    -   Jay Walters has a much lower influence having influencde/collaborated with 51 artists and 50 music.
...
-   However, Sailor Shift has the most recent influence, with new artist connections as recent as 2040.
    -   In contrast, Min Fu's influence period ended earlier (last connection in 2029), while Jay Walters' influence dates back only to 1996.
:::
...
### [2:]{style="color:DarkOrange"} 6.3.2 Visualizing the career of Sailor Shift
...
### [2:]{style="color:DarkOrange"} 6.3.3 Visualizing the career of Chao Wu
...
### [2:]{style="color:DarkOrange"} 6.3.4 Visualizing the career of Xia Jia
...
Donna Caldwell and Xiulan Ye are at 2017 with a count of 170.
:::
...
-   Sailor Shift is ranked 1st in Oceanus Folk star potential.
...
-   This analysis will continue to identity the next 3 emerging artists poised to become the next Oceanus Folk stars.
:::

::: callout-tip
## Chao Wu

-   Chao Wu is the second on the Star Potential list and his influence is large having influenced/collaborated with 190 Artists and influenced the creation of 44 Music with his Oceanus Folk music.
...
-   Xia Jia is the next on the Star Potential list and her influence is equally large having influenced 178 Artists and 42 Music with her Oceanus Folk music.
    -   Furthermore, she has also gained this large following despite having only released 4 music.
    -   Similarly, 3 of them are hits.
    -   Her last Oceanus Folk work was in 2028 but her works were last refereed to in 2030 which is less recent than Chao Wu.
:::

::: callout-tip
## Xiulan Ye

-   Both Xiulan Ye and Donna Caldwell have produced the 2 influential songs Basque Shore and Destiny's Call together. However, Xiulan Ye is slightly more established in the music scene having also produced Unbound from the Doom Metal genre.
