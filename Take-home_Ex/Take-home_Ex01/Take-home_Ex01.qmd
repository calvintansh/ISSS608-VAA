...
Overlaid Plots:
- *ggdraw()* was used to create an empty canvas, and *draw_plot()* was used to overlay s1, s2, and the zoom rectangle. These functions are part of the *cowplot* package.
